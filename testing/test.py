...
data_dir = '/Users/tcmoore3/Desktop/sandbox'
prm.analyze_sweeps(data_dir, verbosity=2)
prm.output = combine(data_dir, 305.0, verbosity=1)
...
prm.plot_diffusion_coefficient_z(output[0], output[6])
prm.plot_symmetrized_free_energy(output[0], output[7])
